...
final class ActivityRecord {
    ...
    static final int APPLICATION_ACTIVITY_TYPE = 0;// 出了下面两种情况的其他Activity
    static final int HOME_ACTIVITY_TYPE = 1;// 带有Home属性的Activity：Launcher Activity或者ResolverActivity（系统弹出让用户选择的哪个应用的Activity）
    static final int RECENTS_ACTIVITY_TYPE = 2;// systemui里的RecentsActivity
    int mActivityType;
    ...
    boolean immersive;      // immersive（沉浸式） mode (don't interrupt if possible)
