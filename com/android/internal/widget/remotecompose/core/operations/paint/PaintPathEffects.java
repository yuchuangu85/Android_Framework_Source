...
public abstract class PaintPathEffects {
     ...
     */
    static int getIds(@NonNull int [] data, int offset, @NonNull Register register) {
    ...
    abstract @NonNull float [] toFloatArray();

    /**
     * Parse a path effect from a float array
     */
    public static @NonNull PaintPathEffects parse(@NonNull float [] data, int offset) {
     ...
     * @return float array
     */
    public static @NonNull float [] encode(@NonNull PaintPathEffects pe) {
     ...
     * @return float array
     */
    public static @NonNull float [] fuze(int type, @NonNull float [] a, @NonNull float [] b) {
    ...
    public static class Dash extends PaintPathEffects {
        public float mPhase;
        public @NonNull float [] mIntervals;
         ...
         */
        public Dash(float phase, @NonNull float ... intervals) {
            this.mPhase = phase;
         ...
         * @param offset offset into the array
         */
        public static @NonNull PaintPathEffects decode(@NonNull float [] data, int offset) {
         ...
         * @return the offset into the array after the ids have been processed
         */
        static int gitIds(@NonNull int [] data, int offset, @NonNull Register register) {
     ...
     */
    private static void registerIfId(@NonNull int [] data, int offset, @NonNull Register register) {
    ...
    public static class Discrete extends PaintPathEffects {
         ...
         * @return the offset into the array after the ids have been processed
         */
        public static int gitIds(@NonNull int [] data, int offset, @NonNull Register register) {
            registerIfId(data, offset, register);
     ...
     */
    public static @NonNull float [] dash(float phase, @NonNull float ... intervals) {
     ...
     */
    public static @NonNull float [] discrete(float segmentLength, float deviation) {
     ...
     * @param style   how to transform the shape at each position as it is stamped
     */
    public static @NonNull float [] pathDash(int shapeId, float advance, float phase, int style) {
     ...
     * Sum two path effects together
     */
    public static @NonNull float [] sum(@NonNull float [] first, @NonNull float [] second) {
     ...
     * Compose two path effects together
     */
    public static @NonNull float [] compose(@NonNull float [] outerPE, @NonNull float [] innerPE) {
