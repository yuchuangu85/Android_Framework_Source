...
final class OpenSSLECGroupContext {
    ...
    static OpenSSLECGroupContext getInstance(ECParameterSpec params)
        ...
        switch (p.bitLength()) {
            case 224:
                if (p.toString(16).equals(
                            "ffffffffffffffffffffffffffffffff000000000000000000000001")
                    && b.toString(16).equals(
                            "b4050a850c04b3abf54132565044b0b7d7bfd8ba270b39432355ffb4")
                    && x.toString(16).equals(
            ...
            case 256:
                ...
                break;
            case 384:
                if (p.toString(16).equals("ffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
                                          + "fffffffeffffffff0000000000000000ffffffff")
                    && b.toString(16).equals("b3312fa7e23ee7e4988e056be3f82d19181d9c6efe81411203140"
                                             + "88f5013875ac656398d8a2ed19d2a85c8edd3ec2aef")
                    && x.toString(16).equals("aa87ca22be8b05378eb1c71ef320ad746e1d3b628ba79b9859f74"
    ...
    ECParameterSpec getECParameterSpec() {
        ...
        final OpenSSLECPointContext generatorCtx = new OpenSSLECPointContext(
                this, new NativeRef.EC_POINT(NativeCrypto.EC_GROUP_get_generator(groupCtx)));
