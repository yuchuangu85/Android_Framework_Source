...
public class ShadowNetworkInfo extends org.robolectric.shadows.ShadowNetworkInfo {
    ...
    @Implementation
    protected void __constructor__(int type, int subtype, String typeName, String subtypeName) {}

    @Implementation
    protected void setDetailedState(NetworkInfo.DetailedState detailedState,
