...
class ImmutableCollections {
    ...
    */
    ...
    static class Access {
        static {
            SharedSecrets.setJavaUtilCollectionAccess(new JavaUtilCollectionAccess() {
                ...
                // BEGIN Android-removed: stable collections are not supported.
                /*
                ...
                */
                // END Android-removed: stable collections are not supported.
            });
        }
    }
    ...
    // Android-removed: stable collections are not supported.
    ...
    static final class Set12<E> extends AbstractImmutableSet<E>
        ...
        public void forEach(Consumer<? super E> action) {
            if (e1 == EMPTY) {
                ...
                // Android-changed: REVERSE is defined in NoPreloadHolder.
                // action.accept(REVERSE ? (E)e1 : e0); // implicit null check
                // action.accept(REVERSE ? e0 : (E)e1);
                action.accept(NoPreloadHolder.REVERSE ? (E)e1 : e0); // implicit null check
                action.accept(NoPreloadHolder.REVERSE ? e0 : (E)e1);
            }
        }
