    ...
    private static final class Proxy implements android.hardware.radio.network.IRadioNetwork
    {
      ...
      @Override public void setSatelliteNetworkInfo(int serial, android.hardware.radio.network.SatelliteNetworkInfo satelliteNetworkInfo) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method setSatelliteNetworkInfo is unimplemented.");
          }
        }
        finally {
          _data.recycle();
      ...
      @Override public void enablePrioritizedNetworkScan(int serial, android.hardware.radio.network.PrioritizedNetworkScanRequest scanRequest) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method enablePrioritizedNetworkScan is unimplemented.");
          }
        }
        finally {
          _data.recycle();
      ...
      @Override public void disablePrioritizedNetworkScan(int serial) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method disablePrioritizedNetworkScan is unimplemented.");
          }
        }
        finally {
          _data.recycle();
      ...
      @Override public void getSupportedNetworkAlertCategories(int serial) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method getSupportedNetworkAlertCategories is unimplemented.");
          }
        }
        finally {
          _data.recycle();
