    ...
    private static final class Proxy implements android.hardware.radio.network.IRadioNetworkIndication
    {
      ...
      @Override public void prioritizedScanModeChanged(int type, boolean prioritized) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method prioritizedScanModeChanged is unimplemented.");
          }
        }
        finally {
          _data.recycle();
      ...
      @Override public void onNetworkSecurityEvents(int type, android.hardware.radio.network.NetworkSecurityEvent[] events) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method onNetworkSecurityEvents is unimplemented.");
          }
        }
        finally {
          _data.recycle();
