    ...
    private static final class Proxy implements android.hardware.contexthub.IEndpointCallback
    {
      ...
      @Override public void onDataFlowHostSinkRegistered(android.hardware.contexthub.DataFlowSinkRegistrationParams params) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method onDataFlowHostSinkRegistered is unimplemented.");
          }
        }
        finally {
          _data.recycle();
      ...
      @Override public void onDataFlowOffloadEndpointUnregistered(android.hardware.contexthub.DataFlowId dataFlowId, android.hardware.contexthub.EndpointId endpointId, android.hardware.contexthub.EndpointId[] destinationIds) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status) {
            throw new android.os.RemoteException("Method onDataFlowOffloadEndpointUnregistered is unimplemented.");
          }
        }
        finally {
          _data.recycle();
