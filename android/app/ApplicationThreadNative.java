...
class ApplicationThreadProxy implements IApplicationThread {
    ...
    public final void schedulePauseActivity(IBinder token, boolean finished,
        ...
        // 通过Binder对象mRemote向源Activity组件所在应用进程发送一个类型为
        // SCHEDULE_PAUSE_ACTIVITY_TRANSACTION的进程间通信请求
    ...
    public final void scheduleLaunchActivity(Intent intent, IBinder token, int ident,
        ...
        // 通过Binder代理对象mRemote向前面创建的应用程序进程发送一个类型为
        // SCHEDULE_LAUNCH_ACTIVITY_TRANSACTION的进程间通信请求
    ...
    public final void scheduleCreateService(IBinder token, ServiceInfo info,
        ...
        data.writeInt(processState);
        try {
            // 通过ApplicationThreadProxy类内部的一个Binder代理对象mRemote向新创建的应用程序进程发送一个
            // 类型为SCHEDULE_CREATE_SERVICE_TRANSACTION的进程间通信请求
    ...
    public void scheduleRegisteredReceiver(IIntentReceiver receiver, Intent intent,
        ...
        data.writeInt(sendingUser);
        data.writeInt(processState);
        // 通过Binder代理对象mRemote向应用程序发送一个类型为SCHEDULE_REGISTERED_RECEIVER_TRANSACTION的进程间通信消息
