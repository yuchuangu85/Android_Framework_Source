 ...
 *
 * <p>Your activity must derive from(源自) {@link FragmentActivity} to use this. From such an activity,
 * you can acquire(获得) the {@link FragmentManager} by calling
 * {@link FragmentActivity#getSupportFragmentManager}.
 */
public abstract class FragmentManager {
    /**
     * Representation(表示) of an entry on the fragment back stack, as created
     ...
     * will be persisted(坚持) across activity instances.
     */
