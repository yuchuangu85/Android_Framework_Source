...
public interface IVirtualMachineCallback extends android.os.IInterface
{
  ...
  public static class Default implements android.system.virtualizationservice.IVirtualMachineCallback
  {
    ...
    @Override public void onGuestAgentRegistered(int cid, android.system.virtualizationcommon.IGuestAgent guestAgent) throws android.os.RemoteException
    {
    }
    @Override
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_onGuestAgentRegistered:
        {
          int _arg0;
          _arg0 = data.readInt();
          android.system.virtualizationcommon.IGuestAgent _arg1;
          _arg1 = android.system.virtualizationcommon.IGuestAgent.Stub.asInterface(data.readStrongBinder());
          data.enforceNoDataAvail();
    ...
    private static final class Proxy implements android.system.virtualizationservice.IVirtualMachineCallback
    {
      ...
      @Override public void onGuestAgentRegistered(int cid, android.system.virtualizationcommon.IGuestAgent guestAgent) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(cid);
          _data.writeStrongInterface(guestAgent);
  ...
  /** Called when guest agent is registered. */
  public void onGuestAgentRegistered(int cid, android.system.virtualizationcommon.IGuestAgent guestAgent) throws android.os.RemoteException;
}
